...
public class BecchuuKanriFormTableModel extends AbstractTableModel {
   private static String[] COLUMN_NAMES = {"別注記号", "分類", "工事番号", "施主名", "納期", "作成者", "別注枚数", "作成状況", "ミス件数", "研修者", "検収状況", "作成日", "別注DB"};
   ...
   public Object getValueAt(int row, int col) {
      ...
      try {
         switch (col) {
            ...
            case 12: //　別注DBアップ状況
               String hinCode = "";
               if (becchuu.getHinCode() != null) hinCode = becchuu.getHinCode();
               return "<html><FONT color=\"#000099\"><u>" + hinCode + "</u></html> ";
